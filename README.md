...
프로젝트를 진행하면서, 로컬 LLM의 한계 때문인지, 아님 바이브 코딩 초보라서 그런지 우여곡절이 너무 많았습니다. 만들면서 겪었던 우여곡절은 [블로그 글](https://blog.naver.com/vagabond-k/224413649567)로 작성했습니다.

우여곡절 끝에 만들어진 라이브러리는 **[DigiFont](https://digifont.vagabond-k.com/)** 웹앱을 구축하는데 사용되었습니다. 자신만의 원하는 형태의 디지털 폰트를 원하셨던 분들께 도움이 되길 기원합니다.
